<x-home-base title="Informasi | Sungai Raya Kepulauan">
  ...
  <div>
    ...
    <form action="{{ route('informasi.index') }}" method="GET" class="flex flex-col md:flex-row items-center gap-4 p-4">
      <!-- Input pencarian -->
      <div class="relative w-full md:w-1/2 flex flex-row gap-4">
        <input type="text" name="search" placeholder="Cari informasi..." value="{{ request('search') }}" class="block w-full p-2 text-sm text-gray-900 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
  ...
  <div class="pagination my-4">
    {{ $informasi->appends(request()->query())->links('pagination::tailwind') }}
  </div>
</x-home-base>